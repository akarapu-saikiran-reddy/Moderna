<x-admin-layout>
    <a href="{{ route('admin.homecards.create') }}" class="container flex justify-center">
                        ...
                        <tbody class="bg-white">
                            @foreach ($item as $items)
                                <tr class="whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.homecards.view', $items->id) }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.homecards.edit', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded">
                                            <img
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.homecards.delete', $items->id) }}"
                                            class="px-4 py-1 text-sm text-white  rounded"

                                ...
                                <tr class="whitespace-nowrap">
                                    ...
                                    <td class="px-6  text-sm text-gray-900">
                                        <div class="rounded-full overflow-hidden">
                                            <img src="{{ asset('Upload/images/homepage/'.$items->image) }}" width="70px" height="100px" alt="">
                                        </div>
                                    </td>
                                    <td class="px-6 ">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ route('admin.homepage.edit', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ route('admin.homepage.delete', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded" onclick="return confirm('are u sure do u want to delete this user?');">

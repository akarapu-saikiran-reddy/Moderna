<x-admin-layout>
    <a href="{{ route('admin.sliders.create') }}" class="container flex justify-center">
                    ...
                    <table>
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr class="whitespace-nowrap">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('admin.sliders.view', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('admin.sliders.edit', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('admin.sliders.delete', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded" onclick="return confirm('are u sure do u want to delete this user?');">

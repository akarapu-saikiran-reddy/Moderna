<x-admin-layout>
    <x-backend.card class="">
        ...
        <form action="{{ route('admin.blog.update', $team->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <img src="{{ asset('Upload/images/blog/' . $team->image) }}" height="150px" width="150px" alt="">

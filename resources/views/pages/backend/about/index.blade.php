                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr class="whitespace-nowrap">
                                <td class="px-6 py-4 text-sm text-gray-500 w-1/9 auto">
                                    {{ $items->id }}
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 overflow-hidden  w-1/9 auto">
                                        {{ $items->title }}
                                    </div>
                                </td>
                                <td class="px-6 py-4   w-3/9 ">
                                    <div class="text-sm " width="200px">
                                        <p>{{ $items->description }}</p>
                                    </div>
                                </td>

                                <td class="px-6 py-4 text-sm text-gray-500 w-1/9">
                                    <img src="{{ asset('Upload/images/about/' . $items->image) }}" height="100px" width="100px" alt="">
                                </td>
                                <td class="px-6 py-4  w-1/9">
                                    <a href="{{ route('admin.about.view', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded">
                                ...
                                <td class="px-6 py-4 w-1/9">
                                    <a href="{{ route('admin.about.edit', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded">
                                ...
                                <td class="px-6 py-4 w-1/9">
                                    <a href="{{ route('admin.about.delete', $items->id) }}" class="px-4 py-1 text-sm text-white  rounded" onclick="return confirm('are u sure do u want to delete this user?');">
